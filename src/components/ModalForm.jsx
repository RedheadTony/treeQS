        ...
        return(
            <Container onClick={onClose}>
                <Content onClick={e => e.stopPropagation()}>
                    ...
                    <FormContent onSubmit={e => {e.preventDefault(); this.sendData()}}>
                        <input value={value} onChange={this.setValue}/>
                    </FormContent>
                    <Actions>
                        <Button style={buttonStyle} onClick={this.sendData}>Ok</Button>
                        <Button style={buttonStyle} onClick={onClose}>Cancel</Button></Actions>
                </Content>
            </Container>
        )
    }
